...
class ListaTarifasExtractor(RestApiExtractor):
    ...
    endpoint = "https://olinda.bcb.gov.br/olinda/servico/Informes_ListaTarifasPorInstituicaoFinanceira/versao/v1/" \
    ...
    def get_data(self) -> pandas.DataFrame:
        ...
        cnpj_list = bancos_df['cnpj_if'].replace(' ', None).dropna().drop_duplicates().tolist()
        ...
        return pandas.json_normalize(list(raw_data), 'value', ['@odata.context', 'cnpj'])
